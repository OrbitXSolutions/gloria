...
export async function generateMetadata({
  ...
  return {
    ...
    description: metaDescription || t('product.defaultDescription', { name: metaTitle || '' }),
    keywords:
      product.keywords ||
      [t('product.keywords.perfume'), t('product.keywords.fragrance'), t('product.keywords.luxury'), metaTitle].join(", "),
    alternates: {
    ...
    openGraph: {
      title: metaTitle || t('product.defaultTitle'),
      description:
        metaDescription || t('product.defaultDescription', { name: metaTitle || '' }),
