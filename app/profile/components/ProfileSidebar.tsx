...
import { User, Package, Heart, Settings, CreditCard, MapPin, Bell, Shield, LogOut, Crown } from "lucide-react"
          ...
          return (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className={cn("text-xs mt-0.5", isActive ? "text-gray-300" : "text-gray-500")}>
                  {item.description}
                </div>
              </div>
            </Link>
