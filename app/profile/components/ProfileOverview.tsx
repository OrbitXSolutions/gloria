...
export function ProfileOverview({
  ...
  const [recentFavorites, setRecentFavorites] = useState<any[]>(initialRecentFavorites);
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600">{tStats("totalOrders")}</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600">{tStats("totalFavorites")}</p>
                <p className="text-2xl font-bold text-gray-900">{user.stats.totalFavorites}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600">{tStats("totalSpent")}</p>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-gray-900 truncate">
                        {favorite.product?.name_en || tSeo("product.defaultTitle")}
                      </p>
                      <p className="text-sm text-gray-600">
