          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg opacity-80 leading-relaxed">
                Become part of an exclusive community where luxury fashion meets unparalleled service and style.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm opacity-75">Curated Designer Collections</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span className="text-sm opacity-75">Personal Style Consultation</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span className="text-sm opacity-75">Exclusive Member Events</span>
              </div>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Join our exclusive fashion community</p>
          </div>
