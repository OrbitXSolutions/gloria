...
const PhoneInput: React.ForwardRefExoticComponent<PhoneInputProps> =
  React.forwardRef<React.ElementRef<typeof RPNInput.default>, PhoneInputProps>(
    ({ className, onChange, value, ...props }, ref) => {
      ...
      props.defaultCountry = "AE"; // Default country code for Egypt
      return (
        <RPNInput.default
          ref={ref}
      ...
      <PopoverContent className="w-[300px] p-0">
        <Command>
          <CommandInput
            ...
            placeholder={locale === "ar" ? "ابحث عن دولة..." : "Search for a country..."}
          />
          <CommandList>
            <ScrollArea ref={scrollAreaRef} className="h-72">
              <CommandEmpty>{locale === "ar" ? "لم يتم العثور على دولة" : "No country found."}</CommandEmpty>
              <CommandGroup>
